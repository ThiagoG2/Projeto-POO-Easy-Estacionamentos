...
public class TelaInicialAdminController {
	@FXML
	...
	@FXML
	private Button btnAbrirEstacionamento;
	@FXML
	...
	@FXML
	public void abreTelaCadastrarFuncionario(ActionEvent event) throws IOException {
		BorderPane testPane = FXMLLoader
				.load(getClass().getResource("/br/ufrpe/easyestacionamento/gui/telaCadastrarFuncionario.fxml"));
	...
	@FXML
	public void abreTelaDeletarFuncionario(ActionEvent event) throws IOException {
		Pane testPane = FXMLLoader
				.load(getClass().getResource("/br/ufrpe/easyestacionamento/gui/telaDeletarFuncionario.fxml"));

		Scene scene = new Scene(testPane);
		Stage primaryStage = new Stage(StageStyle.DECORATED);
		primaryStage.setResizable(false);
		primaryStage.setScene(scene);
		primaryStage.setTitle("Deletar Funcionário");
		primaryStage.show();
	}

	@FXML
	public void abreTelaAtualizarFuncionario(ActionEvent event) throws IOException {
		Pane testPane = FXMLLoader
				.load(getClass().getResource("/br/ufrpe/easyestacionamento/gui/telaAtualizarFuncionario.fxml"));

		Scene scene = new Scene(testPane);
		Stage primaryStage = new Stage(StageStyle.DECORATED);
		primaryStage.setResizable(false);
		primaryStage.setScene(scene);
		primaryStage.setTitle("Atualizar Funcionário");
		primaryStage.show();
	}

	@FXML
	public void abreTelaListarFuncionario(ActionEvent event) throws IOException {
		Pane testPane = FXMLLoader
				.load(getClass().getResource("/br/ufrpe/easyestacionamento/gui/telaListaFuncionarios.fxml"));

		Scene scene = new Scene(testPane);
		Stage primaryStage = new Stage(StageStyle.DECORATED);
		primaryStage.setResizable(false);
		primaryStage.setScene(scene);
		primaryStage.setTitle("Lista de Funcionários");
		primaryStage.show();
	}

	@FXML
	public void abreTelaBuscarFuncionario(ActionEvent event) throws IOException {
		Pane testPane = FXMLLoader
				.load(getClass().getResource("/br/ufrpe/easyestacionamento/gui/telaBuscarFuncionario.fxml"));

		Scene scene = new Scene(testPane);
		Stage primaryStage = new Stage(StageStyle.DECORATED);
		primaryStage.setResizable(false);
		primaryStage.setScene(scene);
		primaryStage.setTitle("Buscar Funcionário");
		primaryStage.show();
	}
	...
	@FXML
	public void abreTelaAbrirEstacionamento(ActionEvent event) throws IOException {
		Pane testPane = FXMLLoader
				.load(getClass().getResource("/br/ufrpe/easyestacionamento/gui/TelaAbrirEstacionamento.fxml"));

		Scene scene = new Scene(testPane);
		Stage primaryStage = new Stage(StageStyle.DECORATED);
		primaryStage.setResizable(false);
		primaryStage.setScene(scene);
		primaryStage.setTitle("Abrir Estacionamento");
		primaryStage.show();
	}

	@FXML
	public void abreTelaFecharEstacionamento(ActionEvent event) throws IOException {
		Pane testPane = FXMLLoader
				.load(getClass().getResource("/br/ufrpe/easyestacionamento/gui/TelaFecharEstacionamento.fxml"));

		Scene scene = new Scene(testPane);
		Stage primaryStage = new Stage(StageStyle.DECORATED);
		primaryStage.setResizable(false);
		primaryStage.setScene(scene);
		primaryStage.setTitle("Fechar Estacionamento");
		primaryStage.show();
	}
